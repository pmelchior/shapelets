#ifndef SEXFRAMEEXTENDED_H
#define SEXFRAMEEXTENDED_H
...
class SExFrameExtended : public FitsImage<double> {
 public:
  ...
  SExFrameExtended(std::string fitsfile);
  /// Destructor.
  ~SExFrameExtended();
 ...
 private:
  ...
  SExCatFormatExtended sf;
  std::vector<SExCatObjectExtended> objectList;
