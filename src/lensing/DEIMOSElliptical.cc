...
namespace shapelens {
  ...
  DEIMOSElliptical::DEIMOSElliptical (const Object& obj, const DEIMOSElliptical::PSFMultiScale& psf, int N_, int C_, data_t matching_scale_) :
